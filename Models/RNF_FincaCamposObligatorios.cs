...
namespace RNF_Web.Models
{
    ...
    public partial class Tbl_RNF_Finca
    {
        public class urlmetadata
        {
            ...
            public string ConstanciaDePropiedad_id { get; set; }
            ...
            [RegularExpression(@"^\d+(\.\d{1,3})?$", ErrorMessage = "Formato invalido en area total se espera valor con hasta tres decimales.")]
