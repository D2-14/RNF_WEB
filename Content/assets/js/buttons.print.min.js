(function (d) {
        ...
        function (e) {
            return d(e,
                ...
                document)
                                                                      ...
                                                                      c) {
        e || (e = window);
        if (!c || !c.fn.dataTable) c = require("datatables.net")(e,
            c).$;
        c.fn.dataTable.Buttons || require("datatables.net-buttons")(e,
            c);
        return d(c,
            e,
            e.document)
    ...
    i.ext.buttons.print = {
        ...
        action: function (a,
                          ...
                          c,
                          h) {
            var a = b.buttons.exportData(d.extend({decodeEntities: !1},
                h.exportOptions)),
            ...
            for (var b = b + "<tbody>",
                ...
                "td");
            b += "</tbody>";
            h.footer && a.footer && (b += "<tfoot>" + f(a.footer,
                "th") + "</tfoot>");
            var b = b + "</table>",
                g = e.open("",
                    "");
            ...
            d("img",
                g.document.body).each(function (a,
                                                b) {
                b.setAttribute("src",
                    l(b.getAttribute("src")))
            });
