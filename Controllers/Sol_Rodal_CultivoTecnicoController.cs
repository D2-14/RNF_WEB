...
{
    public class Sol_Rodal_CultivoTecnicoController : Controller
    {
        private db_RNFEntities db = new db_RNFEntities();

        // GET: Sol_Rodal_CultivoTecnico
        public ActionResult Index(string Guid)
        {
            ...
            return View(db.Tbl_Sol_Rodal_CultivoTecnico.Where(Obj => Obj.Solicitud_id == tbl_Sol_Solicitud.Solicitud_id).ToList());
        }
        ...
        public ActionResult Create(string Guid)
        {
            ...
            {
                return RedirectToAction("../Sol_Rodal_CultivoTecnico/EmptyView");
            }

            ViewBag.Guid = Guid;

            Tbl_Sol_Rodal_CultivoTecnico tbl_Sol_Rodal_CultivoTecnico = new Tbl_Sol_Rodal_CultivoTecnico();

            tbl_Sol_Rodal_CultivoTecnico.Solicitud_id = tbl_Sol_Solicitud.Solicitud_id;
            ...
            long MinFinca = db.Tbl_Sol_Finca.Where(Obj => Obj.Solicitud_id == tbl_Sol_Solicitud.Solicitud_id).FirstOrDefault().Finca_Id;

            int TTipo_de_Area = db.Tbl_Sol_Rodal.Where(Obj => Obj.Solicitud_id == tbl_Sol_Solicitud.Solicitud_id && Obj.Finca_id == MinFinca).FirstOrDefault().Tipo_de_Area;

            ViewBag.Rodal_id = new SelectList(db.Tbl_Sol_Rodal.Where(Obj => Obj.Solicitud_id == tbl_Sol_Solicitud.Solicitud_id && Obj.Finca_id == MinFinca), "Rodal_id", "Rodal_id");

            ViewBag.Tipo_de_Area = new SelectList(db.Tbl_Sol_Rodal_Tipo, "Tipo_de_Area", "Descripcion", TTipo_de_Area);
            ...
            return View(tbl_Sol_Rodal_CultivoTecnico);
        ...
        public JsonResult AgregarCultivo(long solicitud_id, long finca_id, long rodal_id, int area_id, int cultivo_id, int anioestablecimiento, decimal Volumen_Rodal, decimal Volumen_ha)
        {
            ...
            int encontrado = db.Tbl_Sol_Rodal_CultivoTecnico.Where(Obj => Obj.Solicitud_id == solicitud_id && Obj.Finca_id == finca_id && Obj.Rodal_Id == rodal_id && Obj.Tipo_de_Area == area_id && Obj.Cultivo_id == cultivo_id && Obj.Anio_Establecimiento == anioestablecimiento).Count();
            ...
            if (encontrado == 0)
            {
                ...
                tbl_Sol_Rodal_CultivoTecnico.Solicitud_id = solicitud_id;
                tbl_Sol_Rodal_CultivoTecnico.Finca_id = finca_id;
                tbl_Sol_Rodal_CultivoTecnico.Rodal_Id = rodal_id;
                tbl_Sol_Rodal_CultivoTecnico.Tipo_de_Area = area_id;
                tbl_Sol_Rodal_CultivoTecnico.Cultivo_id = cultivo_id;
                tbl_Sol_Rodal_CultivoTecnico.Anio_Establecimiento = anioestablecimiento;
                tbl_Sol_Rodal_CultivoTecnico.Volumen_ha = Volumen_ha;
                tbl_Sol_Rodal_CultivoTecnico.Volumen_Rodal = Volumen_Rodal;

                db.Tbl_Sol_Rodal_CultivoTecnico.Add(tbl_Sol_Rodal_CultivoTecnico);
                db.SaveChanges();
        ...
        public JsonResult EliminarCultivo(long solicitud_id, long finca_id, long rodal_id, int area_id, int cultivo_id)
        {
            ...
            Tbl_Sol_Rodal_CultivoTecnico tbl_Sol_Rodal_CultivoTecnico = db.Tbl_Sol_Rodal_CultivoTecnico.Where(Obj => Obj.Solicitud_id == solicitud_id && Obj.Finca_id == finca_id && Obj.Rodal_Id == rodal_id && Obj.Tipo_de_Area == area_id && Obj.Cultivo_id == cultivo_id).First();

            db.Tbl_Sol_Rodal_CultivoTecnico.Remove(tbl_Sol_Rodal_CultivoTecnico);
            db.SaveChanges();
