...
{
    public class Sol_Empresa_Entidad_MateriaPrimaController : Controller
    {
        ...
        public ActionResult Index(int SolicitudId)
        {
            ...
            return View(db.Tbl_Sol_Empresa_Entidad_Materia_Prima.Where(Obj => Obj.Solicitud_id == SolicitudId).ToList());
        ...
        public ActionResult Create(int SolicitudId)
        {
            ...
            //2   Depósitos de Productos Forestales
            //3   Centro de Acopio de Productos Forestales
            ...
            //ViewBag.lstMateriaPrima = new SelectList(db.Tbl_Gral_Materia_Prima, "Materia_Prima_Id", "Nombres_Comunes");
        ...
        public JsonResult AgregarMateriaPrima(long SolicitudId, int MateriaPrimaId)
        {
            ...
            int encontrado = db.Tbl_Sol_Empresa_Entidad_Materia_Prima.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Materia_Prima_id == MateriaPrimaId).Count();

            if ((encontrado == 0) && ((tbl_Sol_Solicitud.Estado_id == 0) || (tbl_Sol_Solicitud.Estado_id == 4) || (objUs.EsInterno == 1)))
            {
                Tbl_Sol_Empresa_Entidad_Materia_Prima tbl_Sol_Empresa_Entidad_Materia_Prima = new Tbl_Sol_Empresa_Entidad_Materia_Prima();

                tbl_Sol_Empresa_Entidad_Materia_Prima.Solicitud_id = SolicitudId;
                tbl_Sol_Empresa_Entidad_Materia_Prima.Materia_Prima_id = MateriaPrimaId;

                db.Tbl_Sol_Empresa_Entidad_Materia_Prima.Add(tbl_Sol_Empresa_Entidad_Materia_Prima);
                db.SaveChanges();
        ...
        public JsonResult EliminarMateriaPrima(long SolicitudId, int MateriaPrimaId)
        {
            ...
            Tbl_Sol_Empresa_Entidad_Materia_Prima tbl_Sol_Empresa_Entidad_Materia_Prima = db.Tbl_Sol_Empresa_Entidad_Materia_Prima.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Materia_Prima_id == MateriaPrimaId).First();

            if (((tbl_Sol_Solicitud.Estado_id == 0) || (tbl_Sol_Solicitud.Estado_id == 4) || (objUs.EsInterno == 1)))
            {
                db.Tbl_Sol_Empresa_Entidad_Materia_Prima.Remove(tbl_Sol_Empresa_Entidad_Materia_Prima);
                db.SaveChanges();
            }
