...
{
    public class Form_FormularioSubRegionalOficioTecnicoCriticaController : Controller
    {
        db_RNFEntities db = new db_RNFEntities();
        // GET: OficioTecnico_EnmiendaCritica
        ...
        //    Tbl_Gest_EtapaSolicitud_OficioTecnico_Enmienda_Critica oCriticasOficioTecnico_Enmienda = new Tbl_Gest_EtapaSolicitud_OficioTecnico_Enmienda_Critica();
        //    oCriticasOficioTecnico_Enmienda.Solicitud_Guid_id = guidsolicitud;
        //    oCriticasOficioTecnico_Enmienda.EtapaSolicitud_Guid_id = guidetapasolicitud;
        //    oCriticasOficioTecnico_Enmienda.Solicitud_id = oEtapaSolicitud.Solicitud_id;
        //    oCriticasOficioTecnico_Enmienda.Etapa_id = oEtapaSolicitud.Etapa_id;
        //    oCriticasOficioTecnico_Enmienda.EtapaRuta_id = oEtapaSolicitud.EtapaRuta_id;
        //    oCriticasOficioTecnico_Enmienda.CorrelativoEtapa_id = oEtapaSolicitud.CorrelativoEtapa_id;
        //    oCriticasOficioTecnico_Enmienda.swcreatedby = objUs.intUsuario_id;
        //    oCriticasOficioTecnico_Enmienda.swcreatedbyinterno = true;

        //    return View(oCriticasOficioTecnico_Enmienda);
         return View();
        }
            ...
            if (oEtapaSolicitud != null)
            {
                ...
                if (oOficioTecnico_Enmienda.Count() > 0)
                {
                    ...
                    for (int i = 0; i < oOficioTecnico_Enmienda.Count(); i++)
                    {
                        ...
                        if((oOficioTecnico_Enmienda[i].Descripcion != null) && (oOficioTecnico_Enmienda[i].Descripcion != ""))
                        {
                            strvalidar = oOficioTecnico_Enmienda[i].Descripcion;
                            if(strvalidar.Trim() != "")
                            {
                        ...
                        if ((oOficioTecnico_Enmienda[i].Objecion != null) && (oOficioTecnico_Enmienda[i].Objecion != ""))
                        {
                            strvalidar = oOficioTecnico_Enmienda[i].Objecion;
                            if (strvalidar.Trim() != "")
                            {
                                oObjecionesOficio.Add($"{oOficioTecnico_Enmienda[i].Objecion.Trim()}");
                            }
                        }
