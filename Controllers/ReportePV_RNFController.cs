...
{
    public class ReportePV_RNFController : Controller
    {
        ...
        private void LlenaDatosDeLaFinca(Tbl_RNF_Finca tbl_RNF_finca, Tbl_RNF_Registro tbl_RNF_Registro)
        {
            bool ProcedenciaExterna = false;
            decimal solicitudtipoid = (decimal)(tbl_RNF_Registro.SolicitudTipo_id??0);
            decimal GestionTIpoId = solicitudtipoid - Math.Truncate(solicitudtipoid);
            if ((tbl_RNF_Registro.Procedencia_PinpepNew || tbl_RNF_Registro.Procedencia_PinpepOld || tbl_RNF_Registro.Procedencia_Probosque || tbl_RNF_Registro.Procedencia_secorf) && ((GestionTIpoId == 0) && (Math.Truncate(solicitudtipoid) == 100)))
            {
            ...
            if (tbl_RNF_finca.ConstanciaDePropiedad_id == 1)
            {
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.RegNumero, fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.RegFolio, fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.RegLibro, fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.Tbl_Gral_DepartamentoRegistro.Departamento, fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
            ...
            if (tbl_RNF_finca.ConstanciaDePropiedad_id == 2)
            {
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.ActaNotarial_Notario, fntTituloTabla));
                c1.Colspan = 3;
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
            ...
            if (tbl_RNF_finca.ConstanciaDePropiedad_id == 3)
            {
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.ActaNotarialConCertificacion_NombreDeCertificador, fntTituloTabla));
                c1.Colspan = 3;
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
            ...
            if (tbl_RNF_finca.ConstanciaDePropiedad_id == 4)
            {
                ...
                c1 = new PdfPCell(new Phrase(tbl_RNF_finca.ActaNotarialDeEscrituraPublica_Numero, fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
                ...
                c1 = new PdfPCell(new Phrase((tbl_RNF_finca.ActaNotarialDeEscrituraPublica_Fecha ?? DateTime.Now).ToString("dd/MM/yyyy"), fntTituloTabla));
                c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                tablePersoneria.AddCell(c1);
            ...
            if (tbl_RNF_finca.ConstanciaDePropiedad_id >= 5)
            {
                ...
                if ((tbl_RNF_finca.ConstanciaPropiedadDescripcion ?? "") != "")
                {
                    c1 = new PdfPCell(new Phrase("Descripcion del respaldo de adquisicion: ", fntTituloTabla));
                    c1.BackgroundColor = iTextSharp.text.BaseColor.LIGHT_GRAY;
                    tablePersoneria.AddCell(c1);

                    c1 = new PdfPCell(new Phrase(tbl_RNF_finca.ConstanciaPropiedadDescripcion, fntTituloTabla));
                    c1.Colspan = 3;
                    c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
                    tablePersoneria.AddCell(c1);
                }
                ...
                if ((tbl_RNF_finca.ActaNotarial_Notario ?? "") != "")
                {
                ...
                if ((tbl_RNF_finca.ActaNotarialDeEscrituraPublica_Numero ?? "") != "")
                {
                    c1 = new PdfPCell(new Phrase("Número de escritura: ", fntTituloTabla));
                    c1.BackgroundColor = iTextSharp.text.BaseColor.LIGHT_GRAY;
                    tablePersoneria.AddCell(c1);
        ...
        private void EspeciesForestales_Probosque(string No_Registro)
        {
            ...
            if (tbl_RNF_Finca_Probosque_EspeciesForestales.Count() > 0)
            {
                ...
                for (int i = 0; i < tbl_RNF_Finca_Probosque_EspeciesForestales.Count(); i++)
                {
                    ...
                    c1 = new PdfPCell(new Phrase($"{tbl_RNF_Finca_Probosque_EspeciesForestales[i].Referencia_id.ToString().ToLower()}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);

                    c1 = new PdfPCell(new Phrase($"{tbl_RNF_Finca_Probosque_EspeciesForestales[i].Area.ToString().ToLower()}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);
                    ...
                    {
                        c1 = new PdfPCell(new Phrase($"{((DateTime)tbl_RNF_Finca_Probosque_EspeciesForestales[i].FechaPlantacion).ToString("yyyy")}", fntSubTitulo));
                        c1.Colspan = 1;
                        c1.Border = 1;
                        tableEstimacion.AddCell(c1);
                    }
        ...
        private void EspeciesForestales_Secorf(string No_Registro)
        {
            ...
            if (tbl_RNF_Finca_Secorf_EspeciesForestales.Count() > 0)
            {
                ...
                for (int i = 0; i < tbl_RNF_Finca_Secorf_EspeciesForestales.Count(); i++)
                {
                    ...
                    c1 = new PdfPCell(new Phrase($"{(tbl_RNF_Finca_Secorf_EspeciesForestales[i].DAP ?? 0).ToString("0.00")}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);

                    c1 = new PdfPCell(new Phrase($"{(tbl_RNF_Finca_Secorf_EspeciesForestales[i].Altura ?? 0).ToString("0.00")}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);

                    c1 = new PdfPCell(new Phrase($"{(tbl_RNF_Finca_Secorf_EspeciesForestales[i].Densidad_ha ?? 0).ToString("0")}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);
                    ...
                    c1 = new PdfPCell(new Phrase($"{(tbl_RNF_Finca_Secorf_EspeciesForestales[i].Volumen ?? 0).ToString("0")}", fntSubTitulo));
                    c1.Colspan = 1;
                    c1.Border = 1;
                    tableEstimacion.AddCell(c1);
        ...
        private void LlenaDatosPlantacion(Tbl_RNF_Finca tbl_RNF_Finca)
        {
            ...
            if (tbl_RNF_Finca.Reforestacion_CONAP == true)
            {
        ...
        private void FirmaSolicitante(Personerias personerias)
        {
            bool printed = false;
        ...
        private void LlenaDatosProfesionalDireccion(Tbl_RNF_Registro tbl_RNF_Registro)
        {
            ...
            c1 = new PdfPCell(new Phrase(globalUtils.InitCap(tbl_RNF_TecnicoProfesional.Tbl_Gral_Departamento1.Departamento), fntTituloTabla));
            c1.Colspan = 1;
            c1.BackgroundColor = iTextSharp.text.BaseColor.WHITE;
            tableDatosNotificacion.AddCell(c1);
        ...
        private void LlenaDatosDeLaEmpresa(Tbl_RNF_Registro tbl_RNF_Registro, fc_RNF_Sel_Direccion_Result DireccionSolicitud)
        {
            ...
            if (tbl_RNF_Empresa_Entidad != null)
            {
                ...
                if ((tbl_RNF_Registro.Tbl_RNF_Empresa_Entidad.Tipo_Industria_id == 2)|| (tbl_RNF_Registro.SolicitudTipo_id >= 5 && tbl_RNF_Registro.SolicitudTipo_id <= 6 && tbl_RNF_Registro.Sub_Categoria_id == 3))
                {
        ...
        public JsonRespuesta GenerarFormularioDeSolicitud_PDF(string No_Registro)
        {
            ...
            string sqlQuery = "Exec SP_RNF_Enviar_Registro_CorregirTexto @No_Registro";
            ...
            strNombre = $"Formulario_{nombre}.pdf";
            ...
            try
            {
                ...
                //Result_SP_IdentificadorOficialGestion resultsp = identificadorOficialGestion.ObtenerDatosDocumentos(10, tbl_RNF_Registro.Solicitud_id, 1, 1, 1, objUs.intUsuario_id);

                //Tbl_Gral_SolicitudConfiguracionTipo tbl_Gral_SolicitudConfiguracionTipo = (from d in db.Tbl_Gral_SolicitudConfiguracionTipo
                //                                                                           where d.SolicitudTipo_id == tbl_RNF_Registro.SolicitudTipo_id
                //                                                                           select d).FirstOrDefault();
                ...
                //else
                //{
                //    strNumero = tbl_RNF_Registro.Solicitud_NumeroTemporal;
                ...
                {
                    if ((objUs.EsInterno == 1) && (tbl_RNF_Registro.Procedencia_PinpepNew || tbl_RNF_Registro.Procedencia_PinpepOld || tbl_RNF_Registro.Procedencia_Probosque || tbl_RNF_Registro.Procedencia_secorf))
                    {
                    }
                    else
                    {
                        ...
                        intTexto_Romano = intTexto_Romano + 1;
                        doc.Add(tableBanner);
                        LlenaDatosNotificacionDetallada(tbl_RNF_Registro);
                        doc.Add(tableDatosNotificacion);
                        doc.Add(Enter);
                    }
                }
                ...
                for (int i = 0; i < tbl_RNF_Finca.Count(); i++)
                {
                    ...
                    sqlQuery += $"         and Cultivo.Finca_id = {tbl_RNF_Finca[i].Finca_Id} \n";
                    ...
                    //if ((tbl_RNF_Registro.No_Registro == null) && (!tbl_RNF_Registro.Procedencia_PinpepNew && !tbl_RNF_Registro.Procedencia_PinpepOld && !tbl_RNF_Registro.Procedencia_Probosque && !tbl_RNF_Registro.Procedencia_secorf))
                    {
                        ...
                        doc.Add(tableBanner);
                        LlenaDatosPlantacion(tbl_RNF_Finca[i]);
                    ...
                    {
                        EstimacionVolumen(tbl_RNF_Finca[i], Modalidad);
                        doc.Add(tableEstimacion);
                    }

                    if (tbl_RNF_Registro.Categoria_id == 6)
                    {
                        EstimacionVolumenFS(tbl_RNF_Finca[i], Modalidad);
                        doc.Add(tableEstimacion);
                    }
                ...
                else if ((tbl_RNF_Registro.Procedencia_PinpepNew || tbl_RNF_Registro.Procedencia_PinpepOld || tbl_RNF_Registro.Procedencia_Probosque || tbl_RNF_Registro.Procedencia_secorf) && (objUs.EsInterno == 1))
                {
                    if (tbl_Seg_UsuarioExterno != null)
                    {
        ...
        [HttpPost]
        public JsonResult GenerarFormularioDeSolicitud(string No_Registro)
        {


            //A diferencia de la solicitud, un registro no siempre cuenta con el Guid_id si es un caso de Registro migrado o Registro creado, por esto se omite este llamado a la firma

            JsonRespuesta jsonRespuesta = new JsonRespuesta();
            string TextoMostrar, Ubicacion;
            jsonRespuesta.Result = 0;
            jsonRespuesta.Mensaje = "No se ha detectado una sesión";
            ...
            try
            {
                JsonRespuesta Archivo = GenerarFormularioDeSolicitud_PDF(No_Registro);   //GenerarPVJuridico_PDF
                if (Archivo.Result == 1)
                {
                    jsonRespuesta.Result = 1;
        ...
        public ActionResult VerReporte(string Guid_id)//, string Identificador)
        {
            Usuario objUs = new Usuario();
            objUs.intUsuario_id = 0;
            ...
            //try
            //{
            //    usuarioid = long.Parse(SecurEncryptDecrypt.DecryptString(Identificador));
            //}
            //catch (Exception ex)
            //{
            //    return RedirectToAction(actionName: "AccesoDenegado", controllerName: "Home");
            //}

            //if(usuarioid != objUs.intUsuario_id)
            //{
            //    return RedirectToAction(actionName: "AccesoDenegado", controllerName: "Home");
            //}

            //ViewBag.No_Registro = SecurEncryptDecrypt.DecryptString(No_Registro);
            //string decryptsql = db.Database.SqlQuery<string>("select dbo.Fcn_Gral_Desencriptar(@p0)", No_Registro).FirstOrDefault();
            ...
            ViewBag.No_Registro = tbl_RNF_Registro.No_Registro;
