...
{
    public class Sol_Empresa_Entidad_TecnicoActividadController : Controller
    {
        private db_RNFEntities db = new db_RNFEntities();
        // GET: Sol_Empresa_Entidad_TecnicoActividad
        public ActionResult Index(int SolicitudId)
        {
            ViewBag.solicitudid = SolicitudId;
            return View(db.Tbl_Sol_Empresa_Entidad_TecnicoActividad.Where(Obj => Obj.Solicitud_id == SolicitudId).ToList());
        }
        ...
        public JsonResult AgregarActividad(long SolicitudId, int ActividadId)
        {
            ...
            int encontrado = db.Tbl_Sol_Empresa_Entidad_TecnicoActividad.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Actividad_id == ActividadId).Count();
            ...
            {
                Tbl_Sol_Empresa_Entidad_TecnicoActividad tbl_Sol_Empresa_Entidad_TecnicoActividad = new Tbl_Sol_Empresa_Entidad_TecnicoActividad();

                tbl_Sol_Empresa_Entidad_TecnicoActividad.Solicitud_id = SolicitudId;
                tbl_Sol_Empresa_Entidad_TecnicoActividad.Actividad_id = ActividadId;

                db.Tbl_Sol_Empresa_Entidad_TecnicoActividad.Add(tbl_Sol_Empresa_Entidad_TecnicoActividad);
                db.SaveChanges();
        ...
        public JsonResult EliminarActividad(long SolicitudId, int ActividadId)
        {
            ...
            Tbl_Sol_Empresa_Entidad_TecnicoActividad tbl_Sol_Empresa_Entidad_TecnicoActividad = db.Tbl_Sol_Empresa_Entidad_TecnicoActividad.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Actividad_id == ActividadId).First();
            ...
            {
                db.Tbl_Sol_Empresa_Entidad_TecnicoActividad.Remove(tbl_Sol_Empresa_Entidad_TecnicoActividad);
                db.SaveChanges();
            }
