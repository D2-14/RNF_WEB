...
{
    public class Sol_ArrendatarioPersonaJuridicaController : Controller
    {
        db_RNFEntities db = new db_RNFEntities();
        // GET: Sol_ArrendatarioPersonaJuridica
        public ActionResult Index()
        {
            return View(db.Tbl_Sol_ArrendatarioPersonaJuridica.ToList());
        }
        ...
        public ActionResult Details(long? id)
        {
            ...
            Tbl_Sol_ArrendatarioPersonaJuridica tbl_Sol_PersonaJuridica = db.Tbl_Sol_ArrendatarioPersonaJuridica.Find(id);
        ...
        public ActionResult Create(long solicitud_id, string firma)
        {
            ...
            Tbl_Sol_ArrendatarioPersonaJuridica tbl_Sol_PersonaJuridica = new Tbl_Sol_ArrendatarioPersonaJuridica();
        ...
        public ActionResult Create(Tbl_Sol_ArrendatarioPersonaJuridica tbl_Sol_PersonaJuridica)
        {
            ...
            int cantidad = db.Tbl_Sol_ArrendatarioPersonaJuridica.Where(Obj => Obj.Solicitud_id == tbl_Sol_PersonaJuridica.Solicitud_id && Obj.No_NIT == tbl_Sol_PersonaJuridica.No_NIT && Obj.Estado_id == true).Count();
            ...
            try
            {
                lngIdt = db.Tbl_Sol_ArrendatarioPersonaJuridica.Where(Propietario => Propietario.Solicitud_id == tbl_sol_Solicitud.Solicitud_id).Max(u => u.PersonaJuridica_id);
                lngIdt++;
            ...
            {
                db.Tbl_Sol_ArrendatarioPersonaJuridica.Add(tbl_Sol_PersonaJuridica);
                db.SaveChanges();
        ...
        public ActionResult Eliminar(long solicitud_id, long personaJuridica_id, string firma)
        {
            ...
            Tbl_Sol_ArrendatarioPersonaJuridica tbl_Sol_PersonaJuridica = db.Tbl_Sol_ArrendatarioPersonaJuridica.Where(Obj => Obj.Solicitud_id == solicitud_id && Obj.PersonaJuridica_id == personaJuridica_id).First();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(Tbl_Sol_ArrendatarioPersonaJuridica tbl_Sol_PersonaJuridica)
        {
            ...
            fc_Gral_Sol_Configuracion_Result permisos = db.fc_Gral_Sol_Configuracion(tbl_Sol_PersonaJuridica.Solicitud_id, "Sol_Arrendatario", boolEsInterno).FirstOrDefault();
