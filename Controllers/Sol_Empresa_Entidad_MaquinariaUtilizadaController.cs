...
{
    public class Sol_Empresa_Entidad_MaquinariaUtilizadaController : Controller
    {
        private db_RNFEntities db = new db_RNFEntities();
        // GET: Sol_Empresa_Entidad_MaquinariaUtilizada
        public ActionResult Index(int SolicitudId)
        {
            return View(db.Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Where(Obj => Obj.Solicitud_id == SolicitudId).ToList());
        }
        ...
        public JsonResult AgregarMaquinariaUtilizada(long SolicitudId, int MaquinariaUtilizadaId)
        {
            ...
            int encontrado = db.Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Maquinaria_Utilizada_id == MaquinariaUtilizadaId).Count();

            if ((encontrado == 0) && ((tbl_Sol_Solicitud.Estado_id == 0) || (tbl_Sol_Solicitud.Estado_id == 4) || (objUs.EsInterno == 1)))
            {
                Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada = new Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada();

                tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Solicitud_id = SolicitudId;
                tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Maquinaria_Utilizada_id = MaquinariaUtilizadaId;

                db.Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Add(tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada);
                db.SaveChanges();
        ...
        public JsonResult EliminarMaquinariaUtilizada(long SolicitudId, int MaquinariaUtilizadaId)
        {
            ...
            Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada = db.Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Where(Obj => Obj.Solicitud_id == SolicitudId && Obj.Maquinaria_Utilizada_id == MaquinariaUtilizadaId).First();

            if (((tbl_Sol_Solicitud.Estado_id == 0) || (tbl_Sol_Solicitud.Estado_id == 4) || (objUs.EsInterno == 1)))
            {
                db.Tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada.Remove(tbl_Sol_Empresa_Entidad_Maquinaria_Utilizada);
                db.SaveChanges();
            }
