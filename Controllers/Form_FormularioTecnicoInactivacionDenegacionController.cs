...
{
    public class Form_FormularioTecnicoInactivacionDenegacionController : Controller
    {
        ...
        public string GenerarReporteDeDenegacionTecnica_PDF(long Solicitud_id, string Guidetapa, string Argumentacion)
        {
        ...
        [HttpPost]
        public JsonResult GenerarReporteDeDenegacionTecnica(string Guidid, string Guidetapa, string Argumentacion)
        {
            ...
            try
            {
                Ubicacion = GenerarReporteDeDenegacionTecnica_PDF(tbl_sol_solicitud.Solicitud_id, Guidetapa, Argumentacion);
